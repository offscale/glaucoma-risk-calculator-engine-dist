...
describe('tests risks', function () {
    it('barbados', function () {
        ...
        chai_1.expect(__1.uniq(__1.risks_from_study(risk_json, 'barbados'))).to.have.members(risk_distribution);
    ...
    it('framingham', function () {
        ...
        chai_1.expect(__1.uniq(__1.risks_from_study(risk_json, 'framingham'))).to.have.members(risk_distribution);
    ...
    it('olmsted', function () {
        ...
        chai_1.expect(__1.uniq(__1.risks_from_study(risk_json, 'olmsted'))).to.have.members(risk_distribution);
